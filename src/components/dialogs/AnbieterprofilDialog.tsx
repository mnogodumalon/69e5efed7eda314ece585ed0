...
interface AnbieterprofilDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (fields: Anbieterprofil['fields']) => Promise<void>;
  defaultValues?: Anbieterprofil['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function AnbieterprofilDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: AnbieterprofilDialogProps) {
  const [fields, setFields] = useState<Partial<Anbieterprofil['fields']>>({});
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'anbieterprofil');
      await onSubmit(clean as Anbieterprofil['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        return merged as Partial<Anbieterprofil['fields']>;
      });
  ...
  const DIALOG_INTENT = defaultValues ? 'Anbieterprofil bearbeiten' : 'Anbieterprofil hinzufügen';
    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="beschreibung">Beschreibung der Leistungen</Label>
            <Textarea
              id="beschreibung"
          ...
          <div className="space-y-2">
            <Label htmlFor="profilbild">Profilbild (optional)</Label>
            {fields.profilbild ? (
